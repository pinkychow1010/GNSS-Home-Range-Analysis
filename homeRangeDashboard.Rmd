...
<li><font face="Georgia" size="7em" color="#232a28">Calenge C (2006). “The package adehabitat for the R software: tool for the analysis of space and habitat use by animals.” Ecological Modelling, 197, 1035.</font></li>

<li><font face="Georgia" size="7em" color="#232a28">Tétreault, M., Franke, A. (2017). Home range estimation: examples of estimator effects. Applied raptor ecology: essentials from Gyrfalcon research. The Peregrine Fund, Boise, Idaho, USA, 207-242.</font></li>
